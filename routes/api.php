...
Route::get("khach-hang/loadd", [KhachHangController::class, 'load']);
...
Route::get('/pet/loadd', [PetController::class, 'Load']);

Route::get("lich-hen/loadd",[LichHenPetController::class,'loadd']);
